...
require (
	github.com/DataDog/datadog-agent v0.0.0-20260602145226-99ac9f2c860a
...
require (
	...
	github.com/DataDog/ebpf-manager v0.7.18 // indirect
	...
	github.com/cloudflare/cbpfc v0.0.0-20260219140841-0661ad29132c // indirect
